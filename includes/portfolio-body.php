<body>
    ...
    <div class="projectpart">
        ...
        <div class="portfolio-first-row" id="first-row">
            <div class="portfolio-modal" id="modalbox">
                <div class="portfolio-modalcontent">
                    <div class="portfolio-modal-images-div">
                        <div class="portfolio-proj1-img1">
                            <img src="assets/images/proj1.png" alt="Project 1">
                        </div>
                        <div class="portfolio-proj1-img2">
                            <img src="assets/images/proj1-pic1.png" alt="Project 1">
                            <img src="assets/images/proj1-pic3.png" alt="Project 1">
                        </div>
                    </div>
                    <div class="portfolio-modaldesc">
                    ...
                    <a href="#portfolio-modalcontent" class="portfolio-modalclose">&times;</a>
                </div>
            </div>

            <div class="portfolio-modal" id="modalbox2">
                <div class="portfolio-modalcontent">
                    <div class="portfolio-modal-images-div">
                        <div class="portfolio-proj2-img1">
                    ...
                    <a href="#modalcontent" class="portfolio-modalclose">&times;</a>
                </div>
            </div>

            <div class="portfolio-modal" id="modalbox3">
                <div class="portfolio-modalcontent">
                    <div class="portfolio-modal-images-div">
                        <div class="portfolio-proj3-img1">
            ...
            <div class="portfolio-first-proj">
                ...
                <div class="portfolio-description">
                    ...
                    <div class="portfolio-button-div">
                        <a class="bn39" href="#modalbox"><span class="bn39span">Learn More</span></a>
                    </div>
                </div>
            </div>

            <div class="portfolio-second-proj">
                <div class="portfolio-images">
                ...
                <div class="portfolio-description">
                    ...
                    <div class="portfolio-button-div">
                        <a class="bn39" href="#modalbox2"><span class="bn39span">Learn More</span></a>
                    </div>
                </div>
            </div>
            <div class="portfolio-third-proj">
                <div class="portfolio-images">
                    <img src="assets/images/WORD OF THE DAY PAGE 1.png" alt="Project 1">
                </div>
                <div class="portfolio-description">
                    ...
                    <div class="portfolio-button-div">
                        <a class="bn39" href="#modalbox3"><span class="bn39span">Learn More</span></a>
                    </div>
                </div>
            </div>
        </div>
